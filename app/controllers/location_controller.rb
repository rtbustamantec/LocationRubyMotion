class LocationController < UIViewController
  ...
  def locationManager(manager, didUpdateToLocation:newLocation, fromLocation:oldLocation)
    ...
    @latitudeLabel.text =  @latitudeLabel.text + @latitude.to_s
    @longitudeLabel.text =  @longitudeLabel.text + @longitude.to_s
  ...
  def show_map
    ...
    pointer = MyAnnotation.alloc.initWithCoordinate(location, title:"My location", andSubTitle:"Here!")
